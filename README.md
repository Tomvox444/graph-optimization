# Graph Optimization and Max-Flow Solver

## Overview
This project provides a modular implementation of the Edmonds–Karp algorithm for maximum flow computation, along with advanced graph-theoretic features including residual graph management, Menger edge-disjoint paths, and Laplacian spectral analysis (Fiedler value).
...
- Menger’s theorem (edge-disjoint paths)
- Spectral graph analysis (Laplacian, Fiedler value)
